...
const PAIRING_CONTENT = {
  ...
  "South Africa|Canada": {
    menu: {
      bites: [
        { name: "Bunny Chow Poutine", description: "South African bunny chow curry served poutine-style over fries with melted cheese.",
          serves: "Serves 4", time: "40 min",
          ingredients: ["1 lb fries", "2 cups curry (lamb or chickpea)", "1 cup cheese curds", "1/2 cup gravy", "Cilantro"],
          steps: ["Bake the fries until crisp.", "Warm the curry until thick.", "Layer fries, curds, curry, and gravy.", "Finish with cilantro."] },
        { name: "Maple Boerewors Rolls", description: "South African boerewors sausage in a soft roll with a maple-mustard glaze.",
          serves: "Serves 4", time: "25 min",
          ingredients: ["4 boerewors sausages (or coiled beef sausage)", "Soft rolls", "2 tbsp maple syrup", "1 tbsp mustard", "Caramelized onion"],
          steps: ["Grill the sausages until cooked through.", "Whisk maple syrup and mustard together.", "Tuck sausages into rolls with onion.", "Drizzle with the maple-mustard glaze."] },
        { name: "Melktert Butter Tart Bites", description: "South African melktert custard tart reimagined as Canadian-style butter tart bites.",
          serves: "Serves 6", time: "35 min",
          ingredients: ["Mini tart shells", "1 cup milk", "2 eggs", "1/4 cup sugar", "Cinnamon", "2 tbsp maple syrup"],
          steps: ["Whisk eggs, sugar, cinnamon into the warm milk.", "Stir in maple syrup.", "Fill tart shells, bake until just set.", "Cool slightly before serving."] },
      ],
      drink: { name: "Rooibos Maple Tea", description: "South African rooibos tea sweetened with Canadian maple.",
        serves: "Serves 4", time: "10 min",
        ingredients: ["4 cups brewed rooibos tea", "2 tbsp maple syrup", "Cinnamon stick", "Ice (optional)"],
        steps: ["Brew the rooibos with a cinnamon stick.", "Stir in maple syrup.", "Serve warm or chilled over ice."] },
    },
    common: {
      intro: "South Africa and Canada both turned humble, practical food into national icons — fries and curry, sausage and syrup, comfort built for sharing.",
      connections: [
        { title: "Comfort over fries", description: "South African bunny chow and Canadian poutine both prove that piling rich, saucy food over a starchy base is a universal comfort move." },
        { title: "Sausage traditions", description: "Boerewors and Canadian sausage culture both treat a well-seasoned coiled or grilled sausage as a backyard staple." },
        { title: "Sweetness from the land", description: "Maple syrup and rooibos both come from the land in a way each country takes real pride in, tapped or harvested and used everywhere." },
      ],
    },
  },
  "Netherlands|Morocco": {
    menu: {
      bites: [
        { name: "Tagine Bitterballen", description: "Dutch bitterballen croquettes filled with Moroccan-spiced beef tagine.",
          serves: "Serves 4", time: "45 min",
          ingredients: ["2 cups beef tagine, shredded and thickened", "1 tsp ras el hanout", "Panko", "Flour", "1 egg"],
          steps: ["Stir ras el hanout into the thickened tagine, chill.", "Roll into balls.", "Coat in flour, egg, panko.", "Fry until deep golden."] },
        { name: "Preserved Lemon Stamppot", description: "Dutch mashed-potato stamppot brightened with Moroccan preserved lemon and olives.",
          serves: "Serves 4", time: "30 min",
          ingredients: ["4 potatoes", "2 cups kale", "2 tbsp minced preserved lemon", "Olives", "Butter"],
          steps: ["Boil potatoes and kale together.", "Mash with butter.", "Fold in preserved lemon and olives.", "Serve hot."] },
        { name: "Stroopwafel Chebakia", description: "Dutch caramel stroopwafel flavors meet Morocco's honey-sesame chebakia cookies.",
          serves: "Serves 6", time: "30 min",
          ingredients: ["Stroopwafels, crushed", "1/2 cup honey", "Sesame seeds", "Cinnamon"],
          steps: ["Warm the honey gently.", "Toss crushed stroopwafel pieces in the honey.", "Scatter with sesame seeds and cinnamon.", "Cool slightly before serving."] },
      ],
      drink: { name: "Mint Genever Cooler", description: "Moroccan mint tea with a Dutch juniper-citrus twist (alcohol-free).",
        serves: "Serves 4", time: "10 min",
        ingredients: ["2 cups mint tea", "Juniper-citrus syrup", "Soda water", "Ice"],
        steps: ["Brew and chill the mint tea.", "Stir in the juniper syrup.", "Top with soda over ice."] },
    },
    common: {
      intro: "Centuries of trade between the Netherlands and Morocco have left a real culinary thread — Dutch precision meets Moroccan warmth in spice, citrus, and a shared love of slow-cooked stew.",
      connections: [
        { title: "Slow-cooked richness", description: "Moroccan tagine and Dutch stamppot both reward patience, turning simple ingredients into deeply comforting one-pot meals." },
        { title: "A real community", description: "The Netherlands is home to one of Europe's largest Moroccan communities, and Moroccan flavors have become genuinely woven into Dutch everyday food." },
        { title: "Sweet and golden", description: "Stroopwafel and chebakia both show off a love of honey, caramel, and pastry made to be shared over tea." },
      ],
    },
  },
  "Brazil|Japan": {
    menu: {
      bites: [
        { name: "Miso Coxinha", description: "Brazilian coxinha chicken croquettes with a Japanese miso glaze.",
          serves: "Serves 4", time: "45 min",
          ingredients: ["2 cups shredded chicken", "1 tbsp miso paste", "2 cups dough or mashed potato", "Breadcrumbs", "Oil for frying"],
          steps: ["Mix miso into the shredded chicken.", "Wrap in dough, shape into teardrops.", "Bread and fry until golden.", "Serve hot."] },
        { name: "Temaki Pão de Queijo", description: "Brazilian cheese bread shaped and filled temaki-style with Japanese-inspired fillings.",
          serves: "Serves 4", time: "30 min",
          ingredients: ["2 cups tapioca flour", "1 cup milk", "1.5 cups cheese", "2 eggs", "Cucumber, avocado for filling"],
          steps: ["Make the cheese bread batter and bake into small cones or rolls.", "Cool slightly.", "Fill with cucumber and avocado.", "Serve as bite-sized rolls."] },
        { name: "Brigadeiro Mochi", description: "Brazilian chocolate brigadeiro fudge wrapped in chewy Japanese mochi.",
          serves: "Serves 6", time: "35 min",
          ingredients: ["1 can condensed milk", "3 tbsp cocoa", "1 tbsp butter", "1 cup glutinous rice flour", "Cornstarch"],
          steps: ["Cook condensed milk, cocoa, butter into thick brigadeiro fudge.", "Steam rice flour into mochi dough.", "Wrap brigadeiro balls in mochi.", "Dust with cornstarch."] },
      ],
      drink: { name: "Yuzu Caipirinha Mocktail", description: "Brazilian lime muddle brightened with Japanese yuzu, alcohol-free.",
        serves: "Serves 4", time: "5 min",
        ingredients: ["3 limes", "1 tbsp yuzu juice", "2 tbsp sugar", "Soda water", "Ice"],
        steps: ["Muddle lime, yuzu, and sugar.", "Add ice.", "Top with soda water."] },
    },
    common: {
      intro: "Brazil has the largest Japanese community outside Japan itself, and that history shows up everywhere in Brazilian food — this matchup is a genuine, lived-in fusion, not an invented one.",
      connections: [
        { title: "A real culinary bridge", description: "Japanese immigration to Brazil over the last century created an actual fusion cuisine, blending technique and ingredients in ways both countries now claim with pride." },
        { title: "Rice and wrapping", description: "Temaki rolls and Brazilian pão de queijo both turn a simple base into something wrapped, portable, and snackable." },
        { title: "Precision in sweets", description: "Brigadeiro and mochi both show a careful, almost ritual approach to a small, dense, deeply satisfying dessert." },
      ],
    },
  },
  "Ivory Coast|Norway": {
    menu: {
      bites: [
        { name: "Gravlax Attieke", description: "Norwegian cured gravlax served over Ivorian attieke cassava couscous.",
          serves: "Serves 4", time: "20 min",
          ingredients: ["2 cups attieke (cassava couscous)", "6 oz gravlax", "Dill", "Lemon", "Olive oil"],
          steps: ["Steam or warm the attieke.", "Plate and top with sliced gravlax.", "Scatter dill.", "Finish with lemon and olive oil."] },
        { name: "Brunost Kedjenou", description: "Ivory Coast's slow-braised kedjenou chicken finished with a shaving of Norway's brunost cheese.",
          serves: "Serves 4", time: "50 min",
          ingredients: ["4 chicken thighs", "Tomato", "Ginger", "Onion", "2 oz brunost, shaved"],
          steps: ["Braise chicken with tomato, ginger, onion.", "Simmer 35 min until tender.", "Shave brunost over the top.", "Serve with rice."] },
        { name: "Cardamom Aloko Bites", description: "Ivory Coast's fried sweet plantain (aloko) scented with Norwegian cardamom.",
          serves: "Serves 4", time: "20 min",
          ingredients: ["3 ripe plantains", "1/2 tsp cardamom", "Butter", "Honey"],
          steps: ["Fry plantain chunks until caramelized.", "Toss with cardamom.", "Drizzle with honey.", "Serve warm."] },
      ],
      drink: { name: "Ginger Lingonberry Cooler", description: "West African ginger drink brightened with Norwegian lingonberry.",
        serves: "Serves 4", time: "10 min",
        ingredients: ["2 cups ginger juice or ginger tea", "1/2 cup lingonberry syrup", "Soda", "Ice"],
        steps: ["Mix ginger juice with lingonberry syrup.", "Top with soda over ice.", "Stir and serve."] },
    },
    common: {
      intro: "Two coastal nations built around the catch and the harvest, Ivory Coast and Norway both turn fish, root vegetables, and warming spice into deeply comforting food.",
      connections: [
        { title: "Built around the catch", description: "Norwegian gravlax and Ivorian coastal fish dishes both reflect cultures shaped by what comes from the water." },
        { title: "Slow-cooked patience", description: "Kedjenou's long, gentle braise and Norwegian one-pot cooking both reward time over speed." },
        { title: "Warm spice, used carefully", description: "Cardamom and West African spice blends both show restraint — a little goes a long way in both kitchens." },
      ],
    },
  },
  "Portugal|Ghana": {
    menu: {
      bites: [
        { name: "Jollof Bacalhau", description: "Portuguese salt cod flaked over Ghana's spiced jollof rice.",
          serves: "Serves 4", time: "40 min",
          ingredients: ["1 lb salt cod, soaked and shredded", "2 cups jollof rice", "Tomato", "Onion", "Pepper sauce"],
          steps: ["Cook the jollof rice with tomato and onion.", "Warm the shredded cod.", "Plate rice topped with cod.", "Serve with pepper sauce."] },
        { name: "Waakye Pastéis", description: "Portuguese pastéis pastry filled with Ghana's waakye rice and beans.",
          serves: "Serves 4", time: "40 min",
          ingredients: ["Puff pastry", "1.5 cups cooked waakye (rice and beans)", "1 egg", "Pepper sauce"],
          steps: ["Fill pastry squares with waakye.", "Fold and seal, brush with egg.", "Bake until golden.", "Serve with pepper sauce."] },
        { name: "Pastel de Nata Plantain Tart", description: "Portuguese custard tarts layered with Ghana's fried sweet plantain.",
          serves: "Serves 6", time: "35 min",
          ingredients: ["Puff pastry cups", "2 cups milk", "4 egg yolks", "1 ripe plantain, fried", "Sugar", "Cinnamon"],
          steps: ["Whisk yolks and sugar into warm milk.", "Pour into pastry cups, bake until set.", "Top with fried plantain slices.", "Dust with cinnamon."] },
      ],
      drink: { name: "Sobolo Citrus Sangria", description: "Ghana's hibiscus sobolo with a Portuguese sangria-style citrus touch.",
        serves: "Serves 4", time: "10 min",
        ingredients: ["3 cups hibiscus tea", "Orange slices", "Sugar syrup", "Soda", "Ice"],
        steps: ["Brew and chill the hibiscus tea.", "Add orange slices and sugar syrup.", "Top with soda over ice."] },
    },
    common: {
      intro: "Portuguese trade history touched West Africa's coast directly, and Ghana and Portugal still share a love of rice dishes, salt fish, and rich custard sweets.",
      connections: [
        { title: "Rice as the centerpiece", description: "Ghana's jollof and Portuguese rice dishes both treat well-seasoned rice as the heart of the meal, not a side." },
        { title: "Salt fish traditions", description: "Portuguese bacalhau and Ghana's own preserved and dried fish both turn salt-cured seafood into a beloved staple." },
        { title: "Custard and cream", description: "Portugal's pastel de nata and Ghana's love of rich, sweet treats both show a serious devotion to indulgent dessert." },
      ],
    },
  },
  "Argentina|Cape Verde": {
    menu: {
      bites: [
        { name: "Cachupa Empanadas", description: "Argentine empanadas filled with Cape Verde's slow-cooked cachupa corn and bean stew.",
          serves: "Serves 4", time: "45 min",
          ingredients: ["Empanada dough", "1.5 cups cachupa (corn and bean stew), mashed", "Onion", "Paprika"],
          steps: ["Warm the cachupa with onion and paprika.", "Fill dough rounds, fold and seal.", "Bake or fry until golden.", "Serve hot."] },
        { name: "Asado Pastel de Atum", description: "Argentine-style grilled short rib served alongside Cape Verde's tuna pastel pastries.",
          serves: "Serves 4", time: "40 min",
          ingredients: ["1 lb short rib", "Pastry dough", "1 cup canned tuna", "Onion", "Chimichurri"],
          steps: ["Grill the short rib slowly.", "Fill small pastries with tuna and onion, fry until golden.", "Slice the rib.", "Serve both with chimichurri."] },
        { name: "Dulce de Leche Pão de Cuscuz", description: "Cape Verde's steamed corn cuscuz sweetened Argentine-style with dulce de leche.",
          serves: "Serves 6", time: "30 min",
          ingredients: ["2 cups cornmeal", "1 cup milk", "1/2 cup dulce de leche", "Butter"],
          steps: ["Steam cornmeal with milk and butter until set.", "Swirl in dulce de leche.", "Cut into squares.", "Serve warm or cool."] },
      ],
      drink: { name: "Mate Grogue Cooler", description: "Argentine yerba mate with a Cape Verdean sugarcane sweetness.",
        serves: "Serves 4", time: "10 min",
        ingredients: ["2 cups brewed yerba mate, cooled", "1 tbsp brown sugar syrup", "Lime", "Ice"],
        steps: ["Sweeten the cooled mate with the syrup.", "Add a squeeze of lime.", "Serve over ice."] },
    },
    common: {
      intro: "Argentina and Cape Verde both turn slow-cooked, one-pot meals into the heart of the table, built from corn, beans, and whatever the land and sea provide.",
      connections: [
        { title: "Corn and bean staples", description: "Cape Verde's cachupa and Argentine corn-based dishes both lean on humble, filling grains and legumes as everyday comfort." },
        { title: "From the Atlantic", description: "Both Argentine and Cape Verdean coastal cooking show real skill working with what comes from the sea." },
        { title: "Caramel sweetness", description: "Argentina's dulce de leche and Cape Verde's love of sweet, syrupy treats both lean into rich, slow-cooked sugar." },
      ],
    },
  },
  "Australia|Egypt": {
    menu: {
      bites: [
        { name: "Koshari Meat Pie", description: "Australian meat pie filled with Egypt's koshari lentils, rice, and crispy onions.",
          serves: "Serves 4", time: "50 min",
          ingredients: ["1 cup cooked lentils", "1 cup rice", "Fried onions", "Spiced tomato sauce", "Puff pastry", "1 egg"],
          steps: ["Mix lentils, rice, and tomato sauce.", "Fill pastry cases.", "Top with pastry, brush with egg.", "Bake 20 min, top with fried onions."] },
        { name: "Dukkah Lamington Bites", description: "Australian lamington sponge cake rolled in Egyptian dukkah nut-and-spice crumble.",
          serves: "Serves 6", time: "30 min",
          ingredients: ["Sponge cake squares", "Chocolate glaze", "2 tbsp dukkah", "Shredded coconut"],
          steps: ["Dip sponge squares in chocolate glaze.", "Roll half in coconut, half in dukkah.", "Set on a rack until firm.", "Serve mixed on a platter."] },
        { name: "Kumara Basbousa", description: "Egyptian semolina basbousa cake folded with Australian roasted kumara sweet potato.",
          serves: "Serves 6", time: "40 min",
          ingredients: ["1 cup semolina", "1 kumara, roasted and mashed", "1/2 cup yogurt", "Sugar", "Syrup"],
          steps: ["Mix semolina, mashed kumara, yogurt, sugar into a batter.", "Bake until golden.", "Soak with sweet syrup.", "Cool slightly and cut into squares."] },
      ],
      drink: { name: "Hibiscus Feijoa Cooler", description: "Egyptian karkade hibiscus with an Australian feijoa brightness.",
        serves: "Serves 4", time: "10 min",
        ingredients: ["2 cups hibiscus tea", "1 cup feijoa or apple-guava juice", "Soda", "Ice"],
        steps: ["Chill the hibiscus tea.", "Mix with feijoa juice.", "Top with soda over ice."] },
    },
    common: {
      intro: "Australia and Egypt both turn humble grains and a love of sweet, syrup-soaked baking into dishes that feed a crowd without much fuss.",
      connections: [
        { title: "Grains as the base", description: "Egyptian koshari and Australian meat pies both treat a hearty, filling base as the foundation everything else sits on." },
        { title: "Nutty crunch", description: "Egyptian dukkah and Australian baking both reach for nuts and texture to finish a dish with character." },
        { title: "Syrup-soaked sweets", description: "Egypt's basbousa and Australia's love of rich, sweet treats both show real devotion to dessert done generously." },
      ],
    },
  },
  "Mexico|Ecuador": {
    menu: {
      bites: [
        { name: "Llapingacho Tacos", description: "Ecuador's cheesy potato cakes tucked into Mexican-style soft tortillas.",
          serves: "Serves 4", time: "35 min",
          ingredients: ["2 potatoes, mashed", "1 cup cheese", "Tortillas", "Salsa verde", "Cilantro"],
          steps: ["Mix mashed potato with cheese, form patties.", "Pan-fry until golden.", "Tuck into warm tortillas.", "Top with salsa verde and cilantro."] },
        { name: "Hornado Carnitas Bowl", description: "Mexican carnitas and Ecuadorian hornado roast pork served together over rice.",
          serves: "Serves 4", time: "40 min",
          ingredients: ["1 lb pulled pork (carnitas or hornado-style)", "2 cups rice", "Pickled onion", "Lime", "Cumin"],
          steps: ["Warm the pulled pork with cumin.", "Plate over rice.", "Top with pickled onion.", "Finish with a squeeze of lime."] },
        { name: "Tres Leches Quimbolito", description: "Mexican tres leches cake flavors folded into Ecuador's steamed quimbolito cake.",
          serves: "Serves 6", time: "40 min",
          ingredients: ["1.5 cups flour", "2 eggs", "1/2 cup sugar", "1/2 cup mixed milks (evaporated, condensed, whole)", "Butter"],
          steps: ["Cream butter, sugar, eggs.", "Fold in flour.", "Spoon into cups, steam 25 min.", "Soak with the mixed milks before serving."] },
      ],
      drink: { name: "Naranjilla Agua Fresca", description: "Ecuador's tart naranjilla fruit made Mexican agua fresca-style.",
        serves: "Serves 4", time: "5 min",
        ingredients: ["1 cup naranjilla pulp (or passionfruit)", "3 cups water", "Sugar", "Lime", "Ice"],
        steps: ["Blend naranjilla with water and sugar.", "Strain if needed.", "Add lime and serve over ice."] },
    },
    common: {
      intro: "Mexico and Ecuador share deep Indigenous and Spanish roots, both leaning on corn, potatoes, and pork as the everyday backbone of the table.",
      connections: [
        { title: "Potato and corn staples", description: "Ecuadorian llapingachos and Mexican corn-based dishes both turn Andean and Mesoamerican staples into daily comfort." },
        { title: "Roast pork traditions", description: "Mexican carnitas and Ecuadorian hornado both celebrate slow-roasted, deeply seasoned pork as a centerpiece." },
        { title: "Sweet milk desserts", description: "Tres leches and Ecuadorian quimbolito both show a shared love of soft cake soaked in rich, sweet milk." },
      ],
    },
  },
  "England|DR Congo": {
    menu: {
      bites: [
        { name: "Moambe Scotch Eggs", description: "English scotch eggs wrapped in sausage meat seasoned with DR Congo's moambe palm-nut spice.",
          serves: "Serves 4", time: "40 min",
          ingredients: ["4 soft-boiled eggs", "1 lb sausage meat", "2 tbsp moambe sauce", "Breadcrumbs", "Oil"],
          steps: ["Mix moambe sauce into the sausage meat.", "Wrap each egg.", "Bread and fry until golden.", "Halve and serve."] },
        { name: "Pondu Pie", description: "English hand pie filled with DR Congo's pondu cassava leaf stew.",
          serves: "Serves 4", time: "45 min",
          ingredients: ["1.5 cups pondu (cassava leaf stew)", "Puff pastry", "1 egg"],
          steps: ["Fill pastry cases with the pondu.", "Top with pastry, brush with egg.", "Bake 20 min until golden.", "Serve hot."] },
        { name: "Fufu Banoffee Tart", description: "English banoffee pie with a hint of DR Congo's cassava fufu folded into the base.",
          serves: "Serves 6", time: "35 min",
          ingredients: ["Shortbread crust", "2 tbsp toasted cassava flour", "2 ripe bananas", "Dulce de leche or caramel", "Whipped cream"],
          steps: ["Mix toasted cassava flour into the crumb base.", "Layer banana and caramel.", "Top with whipped cream.", "Chill before serving."] },
      ],
      drink: { name: "Ginger Palm Cooler", description: "English ginger beer with a Congolese palm-coconut note.",
        serves: "Serves 4", time: "5 min",
        ingredients: ["Ginger beer", "1/2 cup coconut water", "Lime", "Ice"],
        steps: ["Mix ginger beer with coconut water.", "Add a squeeze of lime.", "Serve over ice."] },
    },
    common: {
      intro: "England and DR Congo both build comfort food on hand pies and rich, slow-cooked sauces, each treating a humble base as something worth perfecting.",
      connections: [
        { title: "Pie culture", description: "English hand pies and Congolese pastry-wrapped dishes both make a filled, baked pocket a true comfort staple." },
        { title: "Rich, nutty sauces", description: "Congo's palm-nut moambe and English gravies both build deep, savory richness as the heart of a dish." },
        { title: "Resourceful sweetness", description: "Banoffee pie and Congolese sweet treats both turn simple, available ingredients into something genuinely indulgent." },
      ],
    },
  },
  "United States|Bosnia and Herzegovina": {
    menu: {
      bites: [
        { name: "Cevapi Sliders", description: "Bosnian cevapi sausages served American slider-style on mini buns.",
          serves: "Serves 4", time: "30 min",
          ingredients: ["12 cevapi (or small beef sausages)", "Mini slider buns", "Diced onion", "BBQ sauce"],
          steps: ["Grill the cevapi 8-10 min.", "Tuck into mini buns.", "Top with diced onion.", "Drizzle with BBQ sauce."] },
        { name: "Burek Mac and Cheese Bites", description: "American mac and cheese baked inside Bosnian burek pastry.",
          serves: "Serves 4", time: "45 min",
          ingredients: ["Phyllo sheets", "2 cups mac and cheese", "Butter"],
          steps: ["Layer buttered phyllo with mac and cheese filling.", "Roll into coils.", "Bake until golden and crisp.", "Slice and serve."] },
        { name: "Apple Pie Baklava", description: "American apple pie filling layered Bosnian baklava-style with walnuts and syrup.",
          serves: "Serves 6", time: "45 min",
          ingredients: ["Phyllo sheets", "2 apples, diced", "1 cup ground walnuts", "Butter", "Honey syrup", "Cinnamon"],
          steps: ["Layer buttered phyllo with diced apple, walnuts, cinnamon.", "Cut into diamonds.", "Bake until golden.", "Soak with honey syrup."] },
      ],
      drink: { name: "Plum Lemonade", description: "Bosnian plum flavor stirred into classic American lemonade.",
        serves: "Serves 4", time: "5 min",
        ingredients: ["1 cup plum juice", "3 cups lemonade", "Ice", "Mint"],
        steps: ["Mix plum juice into the lemonade.", "Add ice.", "Garnish with mint."] },
    },
    common: {
      intro: "Grilled meat and flaky, layered pastry connect the US and Bosnia — two cultures that take a backyard grill or a slow-baked pastry seriously.",
      connections: [
        { title: "Grilled meat pride", description: "American backyard grilling and Bosnian cevapi both celebrate simply seasoned meat cooked over open flame." },
        { title: "Layered pastry craft", description: "Bosnian burek and American pie crusts both reflect real skill in working with thin, flaky dough." },
        { title: "A sweet, fruity finish", description: "Bosnian plum desserts and classic American fruit pies both lean on seasonal fruit for a comforting end to a meal." },
      ],
    },
  },
  "Portugal|Croatia": {
    menu: {
      bites: [
        { name: "Cevapi Bacalhau", description: "Croatian cevapi sausages served alongside Portugal's shredded salt cod.",
          serves: "Serves 4", time: "40 min",
          ingredients: ["12 cevapi sausages", "1 lb salt cod, soaked and shredded", "Olive oil", "Flatbread"],
          steps: ["Grill the cevapi.", "Warm the shredded cod with olive oil.", "Serve both together with flatbread.", "Finish with a drizzle of olive oil."] },
        { name: "Pasticada Pastéis", description: "Portuguese pastéis pastry filled with Croatia's slow-braised pasticada beef.",
          serves: "Serves 4", time: "55 min",
          ingredients: ["Puff pastry", "1.5 cups braised beef pasticada, shredded", "Red wine reduction", "1 egg"],
          steps: ["Braise beef in red wine until tender, shred.", "Fill pastry squares.", "Fold and seal, brush with egg.", "Bake until golden."] },
        { name: "Rozata Pastel de Nata", description: "Portuguese custard tarts flavored with Croatia's caramel rozata custard.",
          serves: "Serves 6", time: "35 min",
          ingredients: ["Puff pastry cups", "2 cups milk", "4 egg yolks", "1/4 cup caramel sauce", "Cinnamon"],
          steps: ["Whisk yolks into the warm milk.", "Stir in caramel sauce.", "Fill pastry cups, bake until set.", "Dust with cinnamon."] },
      ],
      drink: { name: "Travarica Citrus Sangria", description: "Portuguese sangria with a Croatian herbal travarica note (alcohol-free).",
        serves: "Serves 4", time: "10 min",
        ingredients: ["2 cups grape juice", "Orange slices", "Fresh rosemary", "Soda", "Ice"],
        steps: ["Muddle rosemary into the grape juice.", "Add orange slices, chill.", "Top with soda over ice."] },
    },
    common: {
      intro: "Two Mediterranean and Adriatic coastal cultures, Portugal and Croatia both build a deep food identity around the sea, slow-braised meat, and rich custard sweets.",
      connections: [
        { title: "Coastal pride", description: "Portuguese bacalhau and Croatian seafood traditions both reflect cultures shaped by long, proud relationships with the sea." },
        { title: "Slow-braised classics", description: "Croatian pasticada and Portuguese stews both reward patient, hours-long cooking for deep, layered flavor." },
        { title: "Custard and caramel", description: "Portugal's pastel de nata and Croatia's rozata both show real devotion to rich, silky custard dessert." },
      ],
    },
  },
  "Spain|Austria": {
    menu: {
      bites: [
        { name: "Schnitzel Croquetas", description: "Spanish croquetas with a crispy Austrian schnitzel-style breading and veal filling.",
          serves: "Serves 4", time: "45 min",
          ingredients: ["1 cup minced veal, cooked", "Bechamel sauce", "Flour, egg, breadcrumbs", "Lemon", "Oil for frying"],
          steps: ["Mix veal into a thick bechamel, chill.", "Shape into small logs.", "Coat in flour, egg, breadcrumbs.", "Fry until golden, serve with lemon."] },
        { name: "Sachertorte Churros", description: "Spanish churros dipped in an Austrian sachertorte-style chocolate-apricot sauce.",
          serves: "Serves 6", time: "30 min",
          ingredients: ["Churro dough", "Oil for frying", "1/2 cup dark chocolate", "2 tbsp apricot jam", "Cinnamon sugar"],
          steps: ["Pipe and fry the churros until golden.", "Roll in cinnamon sugar.", "Melt chocolate with apricot jam.", "Serve churros with the sauce for dipping."] },
        { name: "Jamon Wiener Rolls", description: "Austrian-style bread rolls filled with Spanish jamon and manchego.",
          serves: "Serves 4", time: "25 min",
          ingredients: ["Soft bread rolls", "4 oz thin-sliced jamon", "1 cup shredded manchego", "Butter"],
          steps: ["Split and butter the rolls.", "Layer jamon and manchego inside.", "Warm briefly until cheese softens.", "Serve warm."] },
      ],
      drink: { name: "Sangria Apple Spritz", description: "Spanish sangria with an Austrian apple-spritz lightness.",
        serves: "Serves 4", time: "10 min",
        ingredients: ["2 cups red grape juice", "1 cup apple juice", "Orange slices", "Soda water", "Ice"],
        steps: ["Mix grape and apple juice.", "Add orange slices, chill.", "Top with soda over ice."] },
    },
    common: {
      intro: "Spain and Austria both elevate breaded, fried classics and rich, indulgent desserts to a national art form — two old European food cultures that take craft seriously.",
      connections: [
        { title: "Breaded and fried with pride", description: "Spanish croquetas and Austrian schnitzel both treat a crisp, golden breading as a point of technique, not an afterthought." },
        { title: "Cured meat and cheese", description: "Spanish jamon and Austrian charcuterie traditions both reflect deep expertise in curing and aging." },
        { title: "Dessert as ceremony", description: "Austrian sachertorte and Spanish churros both turn dessert into something worth slowing down for." },
      ],
    },
  },
  "Colombia|Ghana": {
    menu: {
      bites: [
        { name: "Jollof Arepas", description: "Colombian arepas topped with Ghana's spiced jollof rice.",
          serves: "Serves 4", time: "40 min",
          ingredients: ["4 arepas", "2 cups jollof rice", "Tomato", "Onion", "Pepper sauce"],
          steps: ["Cook the jollof rice with tomato and onion.", "Toast the arepas.", "Top arepas with the rice.", "Serve with pepper sauce."] },
        { name: "Waakye Bandeja", description: "Ghana's waakye rice and beans served alongside Colombia's bandeja paisa-style chorizo and beans.",
          serves: "Serves 4", time: "40 min",
          ingredients: ["2 cups waakye (rice and beans)", "1/2 cup cooked red beans", "2 chorizo, sliced and cooked", "Pepper sauce"],
          steps: ["Cook the waakye.", "Warm the beans and chorizo.", "Plate together.", "Serve with pepper sauce."] },
        { name: "Arequipe Plantain Tart", description: "Colombian arequipe caramel layered with Ghana's fried sweet plantain.",
          serves: "Serves 6", time: "35 min",
          ingredients: ["Shortbread crust", "1 cup arequipe", "2 ripe plantains, fried", "Whipped cream"],
          steps: ["Press shortbread into a tart base.", "Spread arequipe over.", "Top with fried plantain slices.", "Finish with whipped cream."] },
      ],
      drink: { name: "Tinto Sobolo Cooler", description: "Colombian tinto coffee blended with Ghana's hibiscus sobolo, served cold.",
        serves: "Serves 4", time: "10 min",
        ingredients: ["1 cup strong coffee, chilled", "2 cups hibiscus tea", "Honey", "Ice"],
        steps: ["Brew and chill both the coffee and hibiscus tea.", "Combine and sweeten with honey.", "Serve over ice."] },
    },
    common: {
      intro: "Colombia and Ghana both build comforting meals around rice, beans, and plantain, with a real fondness for caramelized sweetness to finish things off.",
      connections: [
